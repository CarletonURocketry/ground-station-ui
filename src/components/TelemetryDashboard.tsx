  ...
  return (
    <div className="flex-1 bg-white p-6 rounded-lg border border-[#D8DADA] flex flex-col">
      ...
      <div
        ...
        className="flex-1 h-[calc(100%-3rem)] flex flex-col"
      >
      ...
      <div
        style={{ display: activeTab === "dashboard" ? "grid" : "none" }}
        className="grid grid-cols-1 md:grid-cols-6 xl:grid-cols-6 gap-6 h-full"
      >
        {/* Full width items */}
        ...
        <div className="md:col-span-2">
          <Card title="Angular Velocity">
            <GeneralMultiLineChart
              telemetryData={telemetryData.angular_velocity}
              xAxisLabel="Mission time (s)"
        ...
        <div className="md:col-span-2">
          <Card title="Magnetic Field Strength">
            <GeneralMultiLineChart
              telemetryData={telemetryData.magnetic_field}
              xAxisLabel="Mission time (s)"
